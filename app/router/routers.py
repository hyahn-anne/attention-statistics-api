...
@router.get("/attention-score/{user_id}", response_model=schemas.AttentionDetailBase, tags=["AttentionDetail"])
...
@router.get("/attention-score/avg/{user_id}", response_model=schemas.AttentionScoreAverage, tags=["AttentionDetail"])
...
@router.get("/assessment-type-codes/{user_id}", response_model=List[schemas.AssessmentBase], tags=["AttentionDetail"])
...
@router.get("/attention-summary/{user_id}", response_model=List[schemas.AttentionSummary], tags=["AttentionDetail"])
