...
@router.get('/attention-score/avg/{user_id}', response_model=schemas.AttentionScoreAverage, tags=['attention_detail'])
...
@router.get('/attention-summary/{user_id}', response_model=List[schemas.AttentionSummary], tags=['attention_detail'])
